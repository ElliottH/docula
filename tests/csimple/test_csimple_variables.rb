...
class TestCSimpleVariables < Test::Unit::TestCase
  def setup
  ...
  def test_definitions
    ...
    assert_not_nil @parser.parse("int arr[2] = { 5 * 6, foo };")
    assert_not_nil @parser.parse("int arr[2] = { 5 * 6, 6 * 7 };")

    assert_not_nil @parser.parse("char* test = \"string! {\";")
    assert_not_nil @parser.parse("int brace = '{';")
  end
